...
- `plugins/helm/` — Contains the Helm plugin (Go backend + TypeScript/React frontend)
  - `plugins/helm/internal/` — Go backend services (Helm API client, release management, chart operations)
  - `plugins/helm/frontend/` — TypeScript/React frontend package (`@litelens/helm-plugin-frontend`)
