...
const HelmChartMetadata: FC<{
  ...
  if (!chart)
    return (
      <p className="text-muted-foreground p-4 text-xs">No information available for this chart.</p>
    );
      ...
      <div className="grid grid-cols-[120px_1fr] items-start gap-y-2 px-4 pb-4 text-xs">
        ...
        {chart.Home ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-info truncate font-mono hover:underline"
          >
            {chart.Home}
          </a>
        ) : (
        ...
        <span className="text-muted-foreground self-start pt-0.5">Keywords</span>
