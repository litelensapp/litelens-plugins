    ...
    <div className="flex h-full flex-col gap-3">
      <div className="flex items-center gap-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          <DropdownMenu>
            <DropdownMenuTrigger
              className="border-input hover:bg-accent flex h-8 w-48 cursor-pointer items-center justify-between gap-1.5 rounded-md border px-3 text-xs"
          ...
          {!isLoading &&
            ...
            charts.map((chart) => (
              ...
              >
                ...
                <TableCell className="text-muted-foreground max-w-80 text-xs">
